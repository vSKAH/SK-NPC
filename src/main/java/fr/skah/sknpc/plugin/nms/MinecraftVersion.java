package fr.skah.sknpc.plugin.nms;
...
public final class MinecraftVersion {
    ...
    static {
        final Logger logger = SkNpcPlugin.getSkNpcPlugin().getLogger();
        ...
        try {
            ...
            if (hasGatekeeper) {
                ...
                if(found != 1){
                    ...
                    SkNpcPlugin.getSkNpcPlugin().getPluginLoader().disablePlugin(SkNpcPlugin.getSkNpcPlugin());
                }
